...
inherit autotools bash-completion-r1 db-use depend.apache distutils-r1 elisp-common flag-o-matic java-pkg-opt-2 libtool multilib perl-module eutils poly-c_ebuilds
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-1.8.1-revert_bdb6check.patch
	epatch_user
