...
DESCRIPTION="Broadcom Corporation BCM4313 802.11bgn Wireless Network Adapter driver"
HOMEPAGE="http://www.broadcom.com/support/802.11/linux_sta.php"
BASE_URI="http://www.broadcom.com/docs/linux_sta"
BASE_NAME="hybrid-v35"
SRC_URI="amd64? ( ${BASE_URI}/${BASE_NAME}_64-nodebug-pcoem-${PV//./_}.tar.gz )
		x86? ( ${BASE_URI}/${BASE_NAME}-nodebug-pcoem-${PV//./_}.tar.gz )"
...
src_unpack() {
	...
	unpack "${BASE_NAME}${arch_suffix}-nodebug-pcoem-${PV//./_}.tar.gz"
}

src_prepare() {
	# ad for kernel linux 3.10
	epatch "${FILESDIR}/wl-6xx-kmod-011_kernel_3.10.patch"
